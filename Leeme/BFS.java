...
/**
 * ****************************************************************************
 * Compilation: javac BreadthFirstPaths.java Execution: java BreadthFirstPaths G
 * s Dependencies: Graph.java Queue.java Stack.java StdOut.java Data files:
 * http://algs4.cs.princeton.edu/41graph/tinyCG.txt
 * http://algs4.cs.princeton.edu/41graph/tinyG.txt
 * http://algs4.cs.princeton.edu/41graph/mediumG.txt
 * http://algs4.cs.princeton.edu/41graph/largeG.txt
 *
 * Run breadth first search on an undirected graph. Runs in O(E + V) time.
 *
 * % java Graph tinyCG.txt 6 8 0: 2 1 5 1: 0 2 2: 0 1 3 4 3: 5 4 2 4: 3 2 5: 3 0
 *
 * % java BreadthFirstPaths tinyCG.txt 0 0 to 0 (0): 0 0 to 1 (1): 0-1 0 to 2
 * (1): 0-2 0 to 3 (2): 0-2-3 0 to 4 (2): 0-2-4 0 to 5 (1): 0-5
 *
 ...
 * (number of edges) from a source vertex <em>s</em>
 * (or a set of source vertices) to every other vertex in an undirected graph.
 * <p>
...
public class BFS {
     ...
     * @throws IllegalArgumentException unless {@code 0 <= s < V} for each
     * vertex {@code s} in {@code sources}
     */
